  ...
  <div class="tekup-breadcrumb" style="background-image: url(assets/img/ode-banner.jpg)">
    <div class="container">
      <h1 class="post__title">Our Firm</h1>
      <nav class="breadcrumbs">
        <ul>
          <li><a href='?page=home'>Home</a></li>
          <li aria-current="page"> Our Firm</li>
        </ul>
      </nav>
          ...
          <div class="tekup-single-post-content-wrap">
            ...
            <p>Our commitment goes beyond management: we become strategic partners to our clients, providing experience, methodology, and a clear vision for sustainable growth.</p>
              ...
              <div class="tekup-single-thumb">
                <div class="row">
                  <div class="col-lg-6">
                    <img src="assets/img/our-digital-engine/ode-1.jpg" alt="">
                  </div>
                  <div class="col-lg-6">
                    <img src="assets/img/our-digital-engine/ode-2.jpg" alt="">
                  </div>
                </div>
              </div>
